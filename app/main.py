...
def nav(): return '<div class="nav"><a class="primary" href="/dashboard">⌂ الرئيسية</a><a href="/whatsapp-requests">طلبات واتساب</a><a href="/commands">🎙 مساعد الأوامر</a><a href="/naqliat">🚚 شحنات نقليات</a><a href="/freight-workflow">عروض الشحن</a><a href="/shipping-agents">⚓ وكلاء الملاحة</a><a href="/saber">سابر</a><a href="/content-center">✦ صناعة المحتوى</a><a href="/discovery">اكتشاف الفرص</a><a href="/intelligence-v2">الذكاء</a><a href="/sales-copilot">مساعد المبيعات</a><a href="/accounts">العملاء</a><a href="/drivers">السائقون</a><a href="/data-import">استيراد البيانات</a><a href="/opportunities">الفرص</a><a href="/shipments">الشحنات</a><a href="/pipeline">مسار المبيعات</a><a href="/approvals">الموافقات</a><a href="/activity">السجل</a><a class="logout" href="/logout">تسجيل الخروج</a></div>'
