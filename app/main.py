...
app=FastAPI(title='Gulf Logistics AI',version='7.5.0-media-production')
...
def health(): return {'ok':True,'version':'7.5.0-media-production','database':'postgresql','shared_storage':True,'sales_copilot':True,'external_actions':os.getenv('ENABLE_EXTERNAL_ACTIONS','0')=='1'}
@app.get('/')
