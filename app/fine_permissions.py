...
router=APIRouter()
ACTIONS={'send_email':'إرسال البريد','approve_quote':'اعتماد العرض','approve_pricing':'اعتماد التسعير','view_profit':'مشاهدة التكلفة والربحية','manage_users':'إدارة المستخدمين','edit_operations':'تعديل العمليات','manage_gmail':'إدارة Gmail','accept_quote':'تسجيل قبول العميل'}
DEFAULT={'admin':set(ACTIONS),'sales':{'send_email','accept_quote'},'customs':{'edit_operations'},'transport':{'edit_operations'},'finance':{'approve_pricing','view_profit'},'viewer':set()}
def init():
