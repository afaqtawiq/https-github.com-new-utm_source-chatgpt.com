...
async def retell_webhook(request:Request):
    ...
    if event=='call_analyzed' and metadata.get('freight_negotiation'):
        from app.freight_workflow import sync_retell_negotiation
        sync_retell_negotiation(metadata,custom,summary)
