...
SENSITIVE=[('manage_social','POST','/settings/social',''),('publish_social','POST','/content-center/','/schedule'),('send_email','POST','/outbound/','/send'),('send_email','POST','/shipping-agent-messages/','/send'),('send_whatsapp','POST','/commands/broadcast/','/send'),('make_phone_call','POST','/freight-workflow/','/contact-owner'),('approve_quote','POST','/quotes/','/approve-commercial'),('approve_pricing','POST','/quotes/','/approve-pricing'),('accept_quote','POST','/quotes/','/accept'),('manage_gmail','POST','/settings/email',''),('manage_users','POST','/team/',''),('edit_operations','POST','/operations/',''),('edit_operations','POST','/control-tower/','')]
