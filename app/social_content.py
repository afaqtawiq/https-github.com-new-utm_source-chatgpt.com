...
def content_center(request: Request):
    ...
    body = '<div class="nav"><a href="/dashboard">⌂ الرئيسية</a><a href="/content-center">مركز المحتوى</a><a href="/approvals">الموافقات</a>' + ('<a href="/settings/social">إعدادات النشر</a><a href="/settings/media">إعدادات الإنتاج</a>' if session.get('role') == 'admin' else '') + '</div>'
